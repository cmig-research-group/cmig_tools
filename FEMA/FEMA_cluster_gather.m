...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      for job=1:njobs
            ...
            mat_files = dir(sprintf('%s/*/*.mat',jobdirs{job}));
            ...
            if job==1
                  ...
                  % Replace nperms_per_job in the output folder by nperms
                  perm_info = replace(perm_info, perm_info(regexp(perm_info, '\d')), int2str(nperms));
      ...
      % Computing results significance
