...
%                                             (used for sobel test)
% 
% returnResiduals:  if true, GLS residuals are additionally returned 
% 
...
addParameter(p, 'returnResiduals', true);
...
[beta_hat,      beta_se,        zmat,        logpmat,                        ...
 ...
 residuals_GLS, info] =                                                      ...
 FEMA_fit(X, iid, eid, fid, agevec, ymat, contrasts, nbins, GRM,             ...
         'RandomEffects', RandomEffects, 'niter', niter, 'nperms', nperms,   ...
         ...
         'returnResiduals', returnResiduals, 'doPar', doPar,                 ...
...
FEMA_save('mat', dirOutput, 'outPrefix', outPrefix,                         ...
          'beta_hat', beta_hat, 'beta_se', beta_se, 'zmat', zmat,           ...
          'logpmat', logpmat, 'sig2tvec', sig2tvec, 'sig2mat', sig2mat,     ...
          'Hessmat', Hessmat, 'logLikvec', logLikvec,                       ...
          'beta_hat_perm', beta_hat_perm, 'beta_se_perm', beta_se_perm,     ...
          'zmat_perm', zmat_perm, 'sig2tvec_perm', sig2tvec_perm,           ...
          'sig2mat_perm', sig2mat_perm, 'logLikvec_perm', logLikvec_perm,   ...
          'binvec_save', binvec_save, 'nvec_bins', nvec_bins,               ...
          'tvec_bins', tvec_bins, 'FamilyStruct', FamilyStruct,             ...
          'coeffCovar', coeffCovar, 'unstructParams', unstructParams,       ...
          'residuals_GLS', residuals_GLS, 'info', info, 'X', X,             ...
          'iid', iid, 'fid', fid, 'eid', eid, 'saveDesignMatrix', saveDesignMatrix);
...
%             'unstructParams', 'residuals_GLS', 'contrasts', 'hypValues', 'info'};
% 
...
%             'sig2mat_perm', 'logLikvec', 'logLikvec_perm', 'Hessmat',               ...
%             'coeffCovar', 'binvec_save', 'nvec_bins', 'tvec_bins',                  ...
%             'unstructParams', 'residuals_GLS', 'contrasts', 'hypValues', 'info', '-v7.3');
% else
%     save(saveName, 'beta_hat', 'beta_se', 'zmat', 'logpmat', 'sig2tvec', 'sig2mat', ...
%             'beta_hat_perm', 'beta_se_perm', 'zmat_perm', 'sig2tvec_perm',          ...
%             'sig2mat_perm', 'logLikvec', 'logLikvec_perm', 'Hessmat',               ...
...
%                'returnResiduals', 'doPar', 'numWorkers', 'numThreads', 'hypValues');