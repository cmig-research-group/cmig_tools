...
info = struct('Transform',Transform,'Datatype',class(vol),'ImageSize',size(vol),'Description','','Version','NIfTI1','Qfactor',1,'PixelDimensions',sum(M(:,1:3).^2,1).^.5,'SpaceUnits','Millimeter',...
