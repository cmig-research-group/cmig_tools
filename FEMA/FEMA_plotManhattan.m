function fig = FEMA_plotManhattan(fileName, outDir, strTitle, fileFlag, GWASThresh, Chr, bpLoc, logpVals)
...
% Prepare output name, if required
if writeFile
    if doTitle
        outName = ['Manhattan_', strrep(strTitle, ' ', ''), '.png'];
    else
        outName = 'ManhattanPlot.png';
    end
end
