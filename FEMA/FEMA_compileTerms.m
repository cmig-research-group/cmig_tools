function [Vs_famtype, Ws_famtype, Vs_fam, Ws_fam] = FEMA_compileTerms(clusterinfo, binvec, nfamtypes, famtypevec, sig2mat, RandomEffects, GroupByFamType, SingleOrDouble, OLSflag)
%% Compute various Vs and Ws terms for every bin
%% Inputs:
...
% GroupByFamType:   logical     whether to GroupByFamType or nto
% SingleOrDouble:   character   single or double precision
% OLSflag:          logical     OLS or GLS solution
%
%% Outputs:
% Vs_famtype, Ws_famtype, Vs_fam, and Ws_fam as cell types containing "V"
% term across clusters and bins
