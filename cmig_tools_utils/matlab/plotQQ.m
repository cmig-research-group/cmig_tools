function [fig, ll] = plotQQ(h_ax, pVals, strTitle, colOver)
...
% Label the axes
xlabel(h_ax, 'Expected -log_{10} \itp', 'Interpreter', 'tex', 'FontSize', 10, 'FontName', 'Courier');
ylabel(h_ax, 'Observed -log_{10} \itp', 'Interpreter', 'tex', 'FontSize', 10, 'FontName', 'Courier');

% Put a title, if user wants
if doTitle
    title(h_ax, strTitle, 'FontSize', 11, 'FontName', 'Courier');
end