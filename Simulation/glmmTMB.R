...
write.table(glmmTMB_results,"./glmmTMB.txt",row.names=F,quote=F,sep="\t")


#################################################################################
# Comparison - FEMAlog VS true
#################################################################################
CpDat = read.table("./FEMA_binary.txt",sep="\t",header=T)
########### FE
...
#################################################################################
CpDat = read.table("./glmmTMB.txt",sep="\t",header=T)
########### FE
...
#################################################################################
FEMAb_results = read.table("./FEMA_binary.txt",sep="\t",header=T)%>%arrange(VarFFX,VarFID,r)
glmmTMB_results = read.table("./glmmTMB.txt",sep="\t",header=T)%>%arrange(VarFFX,VarFID,r)
########### FE
...
pdf(
  file = "./glmmTMB_FEMAb_fe_diff.pdf",
  # type = "cairo", # ??????
  # res = 1000, # 300ppi ?ֱ???
  width = 10, height = 10,
  bg = "white" # ͸??????
...
pdf(
  file = "./glmmTMB_FEMAb_fe_rmse.pdf",
  # type = "cairo", # ??????
  # res = 1000, # 300ppi ?ֱ???
  width = 10, height = 10,
  bg = "white" # ͸??????
...
pdf(
  file = "./glmmTMB_FEMAb_re_diff.pdf",
  # type = "cairo", # ??????
  # res = 1000, # 300ppi ?ֱ???
  width = 10, height = 10,
  bg = "white" # ͸??????
...
pdf(
  file = "./glmmTMB_FEMAb_re_rmse.pdf",
  # type = "cairo", # ??????
  # res = 1000, # 300ppi ?ֱ???
  width = 10, height = 10,
  bg = "white" # ͸??????
